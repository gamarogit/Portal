...
const integration_scheduler_1 = require("./integration.scheduler");
...
exports.IntegrationModule = IntegrationModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, messaging_module_1.MessagingModule, metrics_module_1.MetricsModule],
        providers: [integration_service_1.IntegrationService, integration_scheduler_1.IntegrationScheduler],
